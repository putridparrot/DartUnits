...
class LumenHour {
  ...
  static double toTalbot(double value) => value * 3600.0;

  /// Converts the supplied LumenHour value to LumenMinute
  static double toLumenMinute(double value) => value * 60.0;

  /// Converts the supplied LumenHour value to LumenSecond
  static double toLumenSecond(double value) => value * 3600.0;
}
...
class LumenMinute {
  ...
  static double toTalbot(double value) => value * 60.0;

  /// Converts the supplied LumenMinute value to LumenHour
  static double toLumenHour(double value) => value / 60.0;

  /// Converts the supplied LumenMinute value to LumenSecond
  static double toLumenSecond(double value) => value * 60.0;
}
...
class LumenSecond {
  ...
  static double toTalbot(double value) => value;

  /// Converts the supplied LumenSecond value to LumenHour
  static double toLumenHour(double value) => value / 3600.0;
...
class Talbot {
  ...
  static double toLumenSecond(double value) => value;
