...
class CubicFeet {
  ...
  static double toMillilitres(double value) => value * 28316.8;

  /// Converts the supplied Cubic Feet value to Litres
  static double toLitres(double value) => value * 28.3168;

  /// Converts the supplied Cubic Feet value to Kilolitres
  static double toKilolitres(double value) => value / 35.3147;

  /// Converts the supplied Cubic Feet value to Teaspoons
  static double toTeaspoons(double value) => value * 4783.74;

  /// Converts the supplied Cubic Feet value to Tablespoons
  static double toTablespoons(double value) => value * 1594.58;

  /// Converts the supplied Cubic Feet value to Quarts
  static double toQuarts(double value) => value * 24.9153;

  /// Converts the supplied Cubic Feet value to Pints
  static double toPints(double value) => value * 49.8307;

  /// Converts the supplied Cubic Feet value to Gallons
  static double toGallons(double value) => value * 6.22884;

  /// Converts the supplied Cubic Feet value to Fluid Ounces
  static double toFluidOunces(double value) => value * 996.614;

  /// Converts the supplied Cubic Feet value to US Teaspoons
  static double toUSTeaspoons(double value) => value * 5745.04;

  /// Converts the supplied Cubic Feet value to US Tablespoons
  static double toUSTablespoons(double value) => value * 1915.01;

  /// Converts the supplied Cubic Feet value to US Quarts
  static double toUSQuarts(double value) => value * 29.9221;

  /// Converts the supplied Cubic Feet value to US Pints
  static double toUSPints(double value) => value * 59.8442;

  /// Converts the supplied Cubic Feet value to US Gallons
  static double toUSGallons(double value) => value * 7.48052;

  /// Converts the supplied Cubic Feet value to US Fluid Ounces
  static double toUSFluidOunces(double value) => value * 957.506;

  /// Converts the supplied Cubic Feet value to US Cups
  static double toUSCups(double value) => value * 117.987;

  /// Converts the supplied Cubic Feet value to Cubic Metres
  static double toCubicMetres(double value) => value / 35.3147;
...
class CubicInches {
  ...
  static double toUSTablespoons(double value) => value * 1.10823;

  /// Converts the supplied Cubic Inches value to US Quarts
  static double toUSQuarts(double value) => value / 57.75;

  /// Converts the supplied Cubic Inches value to US Pints
  static double toUSPints(double value) => value / 28.875;

  /// Converts the supplied Cubic Inches value to US Gallons
  static double toUSGallons(double value) => value / 231.0;

  /// Converts the supplied Cubic Inches value to US Fluid Ounces
  static double toUSFluidOunces(double value) => value / 1.80469;

  /// Converts the supplied Cubic Inches value to US Cups
  static double toUSCups(double value) => value / 14.6457;

  /// Converts the supplied Cubic Inches value to Cubic Metres
  static double toCubicMetres(double value) => value / 61023.7;
  ...
  static double toOilBarrels(double value) => value / 9702.0;
}
...
class CubicMetres {
  ...
  static double toKilolitres(double value) => value * 1.0;

  /// Converts the supplied Cubic Metres value to Teaspoons
  static double toTeaspoons(double value) => value * 168936.0;

  /// Converts the supplied Cubic Metres value to Tablespoons
  static double toTablespoons(double value) => value * 56312.1;

  /// Converts the supplied Cubic Metres value to Quarts
  static double toQuarts(double value) => value * 879.877;

  /// Converts the supplied Cubic Metres value to Pints
  static double toPints(double value) => value * 1759.75;

  /// Converts the supplied Cubic Metres value to Gallons
  static double toGallons(double value) => value * 219.969;

  /// Converts the supplied Cubic Metres value to Fluid Ounces
  static double toFluidOunces(double value) => value * 35195.1;

  /// Converts the supplied Cubic Metres value to US Teaspoons
  static double toUSTeaspoons(double value) => value * 202884.0;

  /// Converts the supplied Cubic Metres value to US Tablespoons
  static double toUSTablespoons(double value) => value * 67628.0;

  /// Converts the supplied Cubic Metres value to US Quarts
  static double toUSQuarts(double value) => value * 1056.69;

  /// Converts the supplied Cubic Metres value to US Pints
  static double toUSPints(double value) => value * 2113.38;

  /// Converts the supplied Cubic Metres value to US Gallons
  static double toUSGallons(double value) => value * 264.172;

  /// Converts the supplied Cubic Metres value to US Fluid Ounces
  static double toUSFluidOunces(double value) => value * 33814.0;

  /// Converts the supplied Cubic Metres value to US Cups
  static double toUSCups(double value) => value * 4166.67;

  /// Converts the supplied Cubic Metres value to Cubic Feet
  static double toCubicFeet(double value) => value * 35.3147;
  ...
  static double toOilBarrels(double value) => value * 6.28981;
}
...
class FluidOunces {
  ...
  static double toCubicMetres(double value) => value / 35195.1;
  ...
  static double toCubicInches(double value) => value * 1.73387;

  /// Converts the supplied Fluid Ounces value to Oil Barrels
  static double toOilBarrels(double value) => value / 5595.57;
}
...
class Gallons {
  ...
  static double toCubicMetres(double value) => value / 219.969;

  /// Converts the supplied Gallons value to Cubic Feet
  static double toCubicFeet(double value) => value / 6.22884;

  /// Converts the supplied Gallons value to Cubic Inches
  static double toCubicInches(double value) => value * 277.419;

  /// Converts the supplied Gallons value to Oil Barrels
  static double toOilBarrels(double value) => value / 34.9723;
}
...
class Kilolitres {
  ...
  static double toCubicMetres(double value) => value * 1.0;
...
class Litres {
  ...
  static double toOilBarrels(double value) => value / 158.987;
}
...
class Millilitres {
  ...
  static double toCubicMetres(double value) => value / 1000000.0;

  /// Converts the supplied Millilitres value to Cubic Feet
  static double toCubicFeet(double value) => value / 28316.8;
  ...
  static double toOilBarrels(double value) => value / 158987.0;
}
...
class OilBarrels {
  ...
  static double toMillilitres(double value) => value * 158987.0;

  /// Converts the supplied Oil Barrels value to Litres
  static double toLitres(double value) => value * 158.987;

  /// Converts the supplied Oil Barrels value to Kilolitres
  static double toKilolitres(double value) => value / 6.28981;

  /// Converts the supplied Oil Barrels value to Teaspoons
  static double toTeaspoons(double value) => value * 26858.7;

  /// Converts the supplied Oil Barrels value to Tablespoons
  static double toTablespoons(double value) => value * 8952.91;

  /// Converts the supplied Oil Barrels value to Quarts
  static double toQuarts(double value) => value * 139.889;

  /// Converts the supplied Oil Barrels value to Pints
  static double toPints(double value) => value * 279.779;

  /// Converts the supplied Oil Barrels value to Gallons
  static double toGallons(double value) => value * 34.9723;

  /// Converts the supplied Oil Barrels value to Fluid Ounces
  static double toFluidOunces(double value) => value * 5595.57;

  /// Converts the supplied Oil Barrels value to US Teaspoons
  static double toUSTeaspoons(double value) => value * 32256.0;

  /// Converts the supplied Oil Barrels value to US Tablespoons
  static double toUSTablespoons(double value) => value * 10752.0;

  /// Converts the supplied Oil Barrels value to US Quarts
  static double toUSQuarts(double value) => value * 168.0;

  /// Converts the supplied Oil Barrels value to US Pints
  static double toUSPints(double value) => value * 336.0;

  /// Converts the supplied Oil Barrels value to US Gallons
  static double toUSGallons(double value) => value * 42.0;

  /// Converts the supplied Oil Barrels value to US Fluid Ounces
  static double toUSFluidOunces(double value) => value * 5376.0;

  /// Converts the supplied Oil Barrels value to US Cups
  static double toUSCups(double value) => value * 662.447;

  /// Converts the supplied Oil Barrels value to Cubic Metres
  static double toCubicMetres(double value) => value / 6.28981;

  /// Converts the supplied Oil Barrels value to Cubic Feet
  static double toCubicFeet(double value) => value * 5.61458;

  /// Converts the supplied Oil Barrels value to Cubic Inches
  static double toCubicInches(double value) => value * 9702.0;
}
...
class Pints {
  ...
  static double toCubicMetres(double value) => value / 1759.75;
  ...
  static double toCubicInches(double value) => value * 34.6774;

  /// Converts the supplied Pints value to Oil Barrels
  static double toOilBarrels(double value) => value / 279.779;
}
...
class Quarts {
  ...
  static double toCubicMetres(double value) => value / 879.877;

  /// Converts the supplied Quarts value to Cubic Feet
  static double toCubicFeet(double value) => value / 24.9153;
  ...
  static double toOilBarrels(double value) => value / 139.889;
}
...
class Tablespoons {
  ...
  static double toCubicMetres(double value) => value / 56312.1;

  /// Converts the supplied Tablespoons value to Cubic Feet
  static double toCubicFeet(double value) => value / 1594.58;

  /// Converts the supplied Tablespoons value to Cubic Inches
  static double toCubicInches(double value) => value * 1.08367;

  /// Converts the supplied Tablespoons value to Oil Barrels
  static double toOilBarrels(double value) => value / 8952.91;
}
...
class Teaspoons {
  ...
  static double toCubicMetres(double value) => value / 168936.0;

  /// Converts the supplied Teaspoons value to Cubic Feet
  static double toCubicFeet(double value) => value / 4783.74;

  /// Converts the supplied Teaspoons value to Cubic Inches
  static double toCubicInches(double value) => value / 2.76837;

  /// Converts the supplied Teaspoons value to Oil Barrels
  static double toOilBarrels(double value) => value / 26858.7;
}
...
class USCups {
  ...
  static double toCubicMetres(double value) => value / 4166.67;

  /// Converts the supplied US Cups value to Cubic Feet
  static double toCubicFeet(double value) => value / 117.987;

  /// Converts the supplied US Cups value to Cubic Inches
  static double toCubicInches(double value) => value * 14.6457;

  /// Converts the supplied US Cups value to Oil Barrels
  static double toOilBarrels(double value) => value / 662.447;
}
...
class USFluidOunces {
  ...
  static double toCubicMetres(double value) => value / 33814.0;

  /// Converts the supplied US Fluid Ounces value to Cubic Feet
  static double toCubicFeet(double value) => value / 957.506;

  /// Converts the supplied US Fluid Ounces value to Cubic Inches
  static double toCubicInches(double value) => value * 1.80469;

  /// Converts the supplied US Fluid Ounces value to Oil Barrels
  static double toOilBarrels(double value) => value / 5376.0;
}
...
class USGallons {
  ...
  static double toCubicMetres(double value) => value / 264.172;

  /// Converts the supplied US Gallons value to Cubic Feet
  static double toCubicFeet(double value) => value / 7.48052;

  /// Converts the supplied US Gallons value to Cubic Inches
  static double toCubicInches(double value) => value * 231.0;

  /// Converts the supplied US Gallons value to Oil Barrels
  static double toOilBarrels(double value) => value / 42.0;
}
...
class USPints {
  ...
  static double toCubicMetres(double value) => value / 2113.38;
  ...
  static double toOilBarrels(double value) => value / 336.0;
}
...
class USQuarts {
  ...
  static double toCubicMetres(double value) => value / 1056.69;

  /// Converts the supplied US Quarts value to Cubic Feet
  static double toCubicFeet(double value) => value / 29.9221;

  /// Converts the supplied US Quarts value to Cubic Inches
  static double toCubicInches(double value) => value * 57.75;

  /// Converts the supplied US Quarts value to Oil Barrels
  static double toOilBarrels(double value) => value / 168.0;
}
...
class USTablespoons {
  ...
  static double toCubicMetres(double value) => value / 67628.0;

  /// Converts the supplied US Tablespoons value to Cubic Feet
  static double toCubicFeet(double value) => value / 1915.01;

  /// Converts the supplied US Tablespoons value to Cubic Inches
  static double toCubicInches(double value) => value / 1.10823;

  /// Converts the supplied US Tablespoons value to Oil Barrels
  static double toOilBarrels(double value) => value / 10752.0;
}
...
class USTeaspoons {
  ...
  static double toCubicMetres(double value) => value / 202884.0;

  /// Converts the supplied US Teaspoons value to Cubic Feet
  static double toCubicFeet(double value) => value / 5745.04;

  /// Converts the supplied US Teaspoons value to Cubic Inches
  static double toCubicInches(double value) => value / 3.32468;

  /// Converts the supplied US Teaspoons value to Oil Barrels
  static double toOilBarrels(double value) => value / 32256.0;
}
